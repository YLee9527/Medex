...
MediaCard 组件在整个应用架构中扮演着关键角色，连接了前端界面、状态管理和后端服务：
...
**图表来源**
- [MediaCard.tsx:86-114](file://src/components/MediaCard.tsx#L86-L114)
...
DispatchEvents --> Complete["完成操作"]
SkipOperation --> Complete
ReturnError --> End([结束])
Complete --> End
```
...
ThemeChanged --> |否| SkipRender[跳过渲染]
NeedReRender --> End([结束])
SkipRender --> End
```
